  ...
  <div className={twMerge('h-full flex flex-col bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/80 shadow-lg', className)}>
    <div className="mb-6">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="flex-1 h-0.5 bg-gradient-to-r from-accent-primary to-accent-secondary rounded-full ml-2"></div>
      </div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl p-4 shadow-sm hover:shadow-md hover:bg-white/90 transition-all duration-300">
            <div className="flex items-start justify-between mb-2">
              <h4 className="font-semibold text-base text-gray-900 group-hover:text-accent-primary transition-colors leading-tight">
                {item.name}
              </h4>
              <div className="w-2 h-2 bg-accent-secondary rounded-full opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 mt-1" />
            </div>
